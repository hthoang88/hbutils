...
typedef NS_ENUM(NSInteger, SIAlertViewContentViewPosision) {
    SIAlertViewContentViewPosisionBottom = 0,
    SIAlertViewContentViewPosisionTop,
    SIAlertViewContentViewPosisionBelowTitle,
    SIAlertViewContentViewPosisionAboveTextFields,
};

@class SIAlertView;
typedef void(^SIAlertViewHandler)(SIAlertView *alertView);
typedef BOOL(^SIAlertViewActionHandler)(SIAlertView *alertView);
typedef void(^SIAlertViewDismissHandler)(SIAlertView *alertView, NSInteger buttonIndex);
...
@property (nonatomic, assign) SIAlertViewTransitionStyle transitionStyle NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR; // default is SIAlertViewTransitionStyleSlideFromBottom
...
@property (nonatomic, assign) SIAlertViewContentViewPosision contentViewPosition; // default is SIAlertViewContentViewPosisionCenter

@property (nonatomic, copy) SIAlertViewHandler willShowHandler;
@property (nonatomic, copy) SIAlertViewHandler didShowHandler;
@property (nonatomic, copy) SIAlertViewDismissHandler willDismissHandler;
@property (nonatomic, copy) SIAlertViewDismissHandler didDismissHandler;
...
- (void)addButtonWithTitle:(NSString *)title
                   ...
                   handler:(SIAlertViewActionHandler)handler;
